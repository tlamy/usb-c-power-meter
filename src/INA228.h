...
public:
  ...
  //  Direct SHUNT_CAL register access (register 0x02).
  //  setShuntCal() writes the value directly and updates current_LSB accordingly.
  uint16_t getShuntCal();
  void setShuntCal(uint16_t value);
